...
const PRODUCTS = {
  siem: {
    ...
    img: "/AquaSecureAI/images/Aqua-siem-dashboard.png",
    features: [
      {
  ...
  soc: {
    ...
    img: "/AquaSecureAI/images/soc-dashboard.png",
    features: [
      {
  ...
  "threat-intel": {
    ...
    img: "/AquaSecureAI/images/tip-dashboard.jpeg",
    features: [
      {
  ...
  "dark-web": {
    ...
    img: "/AquaSecureAI/images/darkweb-dashboard.png",
    features: [
      {
  ...
  phishbot: {
    ...
    img: "/AquaSecureAI/images/product-phishbot.png",
    features: [
      {
  ...
  "asset-management": {
    ...
    img: "/AquaSecureAI/images/assets-dashboard.png",
    features: [
      {
  ...
  grc: {
    ...
    img: "/AquaSecureAI/images/grc-dashboard.png",
    features: [
      {
...
export default function ProductDetailPage() {
  ...
  return (
    <>
      <Helmet>
        <title>{p.name} — Aqua Secure AI</title>
      </Helmet>
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 60% 60% at 50% 40%, rgba(138,99,255,0.06) 0%, transparent 70%)",
          }}
        />
          ...
          >
            {p.features.map((f, i) => (
              <motion.div
                ...
                whileHover={{
                  y: -3,
                  boxShadow: `0 10px 32px ${p.color}14`,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p
                ...
                style={{ color: "rgba(60,50,120,0.60)" }}
              >
                {p.name} is built for security teams who need real results — not
                just dashboards. Whether you're a 2-person team or a 200-person
                enterprise SOC, it scales to your needs.
              </p>
              <Link to="/contact">
                <motion.span
            ...
            <motion.div
              ...
              style={{
                background: `linear-gradient(135deg, ${p.bg}, rgba(255,255,255,0.8))`,
                borderColor: `${p.color}20`,
                boxShadow: `0 4px 28px ${p.color}0e`,
              }}
            >
              <h3
              ...
              <p
                ...
                style={{ color: "rgba(60,50,120,0.60)" }}
              >
                Get access to the full platform on secureye.io — or contact us
