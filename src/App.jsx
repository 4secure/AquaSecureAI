  ...
  return (
    <div style={{
      ...
      <div style={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ position:'absolute', width:120, height:120, borderRadius:'50%', border:'1.5px solid rgba(138,99,255,0.45)', animation:'ringPulse 1.1s ease-out infinite' }}/>
        <div style={{ position:'absolute', width:120, height:120, borderRadius:'50%', border:'1px solid rgba(138,99,255,0.25)', animation:'ringPulse 1.1s ease-out 0.28s infinite' }}/>
        <img src="/assets/images/Aquasecureicon.png" alt="Aqua Secure AI"
  ...
  return (
    <PT>
      <Helmet>
        ...
        <meta name="description" content="AquaSecure stops cyber attacks before they happen — AI threat detection, container security, runtime protection and automated response from code to cloud to prompt." />
    ...
    <>
      ...
      <AnimatePresence mode="sync">
        <Routes location={location} key={location.pathname}>
          ...
          <Route path="/products"        element={<PT><ProductsPage      onDemo={onDemo} /></PT>} />
          <Route path="/products/:slug"  element={<PT><ProductDetailPage  onDemo={onDemo} /></PT>} />
          <Route path="/solutions"       element={<PT><SolutionsPage      onDemo={onDemo} /></PT>} />
          <Route path="/solutions/:slug" element={<PT><SolutionDetailPage onDemo={onDemo} /></PT>} />
          <Route path="/platform"        element={<PT><PlatformPage       onDemo={onDemo} /></PT>} />
          <Route path="/pricing"         element={<PT><PricingPage        onDemo={onDemo} /></PT>} />
          <Route path="/about"           element={<PT><AboutPage          onDemo={onDemo} /></PT>} />
          <Route path="/contact"         element={<PT><ContactPage        onDemo={onDemo} /></PT>} />
          <Route path="*"                element={<HomePage               onDemo={onDemo} />} />
        </Routes>
      </AnimatePresence>
    </>
...
//         <img
//           src="/assets/images/Aquasecureicon.png"
//           alt="Aqua Secure AI"
//           style={{ width: 360, position: 'relative', zIndex: 1 }}
//         />
